...
<html>
	...
	<%@ include file ="Includes/header_nav.jsp" %>
		...
		<main>
			...
			<div>
				<h2> Añade una nueva marca</h2>
			</div>
			<form method = "GET" action = "InsertarMarca">
				...
				<div id="cont_principal_motos">
					<div class="cont_moto_individual">
						...
						<section class="cont_moto_der">
							...
							<label id="label_cont_motos" name="nombre">Marca</label><br>							
							<input type="text" name="marca"><br>
							
						</section>
						<input type="submit" class="botonInsertar" value ="Insertar nuevo marca" >
					</div>
				</div>
			</form>
		</main>
